...
const METRICS = {
  ...
  "boj-outlook-real": {
    ...
    archiveNoteEn: "The Bank of Japan's Outlook Report begins with FY2000; no earlier fiscal year exists.",
    csv: "/data/boj_outlook_real.csv",
    forecastCol: "forecast_real",
    actualCol: "actual_real",
    forecastSourceCol: "forecast_source_url",
    actualSourceCol: "actual_source_url",
