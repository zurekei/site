const T = {
  ja: {
    ...
    d1: "することは一つです。公的な見通しの数値と、実績の数値と、その出典を、毎年並べること。政府見通しと実績の乖離が何年分たまっているかは、そこから見えます。",
  ...
  en: {
    ...
    d1: "It does one thing: lay the official forecast figure, the actual figure, and the source for each, side by side, every year. From that alone, you can see how many years the gap between government forecasts and actual outcomes has been piling up.",
