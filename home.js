...
const INDICATOR_META = [
  ...
  {
    key: "boj-outlook-real",
    nameJa: "日銀展望レポートの実質GDP見通し", nameEn: "BOJ Outlook Report — real GDP forecast",
    descJa: "日銀が四半期ごとに示す、政府とは別の実質GDP見通し。", descEn: "The Bank of Japan's own real GDP forecast, issued quarterly, separate from the government's.",
    unit: "%", kind: "series",
    csv: "/data/boj_outlook_real.csv", forecastCol: "forecast_real", actualCol: "actual_real",
    chartHref: "chart/boj-outlook-real",
  },
  {
    key: "boj-outlook-cpi",
    nameJa: "日銀展望レポートの消費者物価見通し", nameEn: "BOJ Outlook Report — CPI forecast",
    descJa: "日銀が四半期ごとに示す、政府とは別の消費者物価見通し。", descEn: "The Bank of Japan's own consumer price forecast, issued quarterly, separate from the government's.",
    unit: "%", kind: "series",
    csv: "/data/boj_outlook_cpi.csv", forecastCol: "forecast_cpi", actualCol: "actual_cpi",
    chartHref: "chart/boj-outlook-cpi",
  },
  {
    key: "fertility",
